...
![laplace_perplexity_sizes](https://github.com/jhrudden/Shaky_N_GANs/assets/46122209/526ba5f8-3c5e-459d-a14f-e04a629c1718|400)

![li_perplexity_sizes](https://github.com/jhrudden/Shaky_N_GANs/assets/46122209/371a943c-22eb-4934-8e1b-6b4b1f46bafa|400)
...
![laplace_perplexity_train_size](https://github.com/jhrudden/Shaky_N_GANs/assets/46122209/9c880b5f-8a8c-40b1-a5a7-5363c07dce2f|400)
...
$$\text{DLoss} = -\frac{1}{n}\sum_i^n y_ilog(D(x_i)) + (1-y_i)log(1-D(G(z_i)))$$

##### Generator Objective

$$\text{G Loss} = \frac{1}{n}\sum_i^n y_ilog(D(G(z_i)))$$
...
![seq_length_distribution](https://github.com/jhrudden/Shaky_N_GANs/assets/46122209/0e7609d3-08e6-481d-8a79-7e2f0b8a2df2|400)
